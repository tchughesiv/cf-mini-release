...
find /root/cf_nise_installer/cf-release/src/consul-release/.blobs/ -type f -print0 | xargs -0 -I {} truncate {} --size 0
# rm -rf /root/cf_nise_installer/cf-release/src/consul-release/src/*
